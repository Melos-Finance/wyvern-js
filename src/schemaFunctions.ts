...
export type AtomicizedSellEncoder<T> = (
  schema: Schema<T>,
  assets: T[],
  address: string,
...
export const encodeAtomicizedSell: AtomicizedSellEncoder<any> = (
  schema,
  assets,
  address,
  atomicizer
...
export type AtomicizedBuyEncoder<T> = (
  schema: Schema<T>,
  assets: T[],
  address: string,
  atomicizer: WyvernAtomicizerContract
...
export const encodeAtomicizedBuy: AtomicizedBuyEncoder<any> = (
  schema,
  assets,
  address,
  atomicizer
