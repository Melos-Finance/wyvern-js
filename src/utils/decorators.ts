...
// _.flow(f, g) = f ∘ g
const wyvernProtocolErrorTransformer = _.flow(
  schemaErrorTransformer,
  contractCallErrorTransformer
);

export const decorators = {
  asyncWyvernProtocolErrorHandler: asyncErrorHandlerFactory(
    wyvernProtocolErrorTransformer
  ),
  syncWyvernProtocolErrorHandler: syncErrorHandlerFactory(
    wyvernProtocolErrorTransformer
  ),
};
