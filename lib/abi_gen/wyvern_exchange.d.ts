...
export declare class WyvernExchangeContract extends BaseContract {
  ...
  changeMinimumMakerProtocolFee: {
    sendTransactionAsync(
      newMinimumMakerProtocolFee_0: string,
      txData?: Partial<TxData>
    ): Promise<string>;
    estimateGasAsync(
      newMinimumMakerProtocolFee_0: string,
  ...
  changeMinimumTakerProtocolFee: {
    sendTransactionAsync(
      newMinimumTakerProtocolFee_0: string,
      txData?: Partial<TxData>
    ): Promise<string>;
    estimateGasAsync(
      newMinimumTakerProtocolFee_0: string,
  ...
  calculateCurrentPrice_: {
    callAsync(
      ...
      howToCall_5: number,
      calldata_6: string,
      replacementPattern_7: string,
      staticExtradata_8: string,
      txData?: Partial<TxData>
    ): Promise<string>;
  };
  changeProtocolFeeRecipient: {
    sendTransactionAsync(
      newProtocolFeeRecipient_0: string,
      txData?: Partial<TxData>
    ): Promise<string>;
    estimateGasAsync(
      newProtocolFeeRecipient_0: string,
  ...
  orderCalldataCanMatch: {
    callAsync(
      buyCalldata_0: string,
      buyReplacementPattern_1: string,
      sellCalldata_2: string,
      sellReplacementPattern_3: string,
      txData?: Partial<TxData>
    ): Promise<boolean>;
  };
  validateOrder_: {
  ...
  calculateFinalPrice: {
    callAsync(
      ...
      basePrice_2: string,
      extra_3: string,
      listingTime_4: string,
      expirationTime_5: string,
      txData?: Partial<TxData>
    ): Promise<string>;
  };
  ...
  ordersCanMatch_: {
    callAsync(
      addrs_0: string[],
      uints_1: string[],
      feeMethodsSidesKindsHowToCalls_2: number[],
      calldataBuy_3: string,
      calldataSell_4: string,
      replacementPatternBuy_5: string,
      replacementPatternSell_6: string,
      staticExtradataBuy_7: string,
      staticExtradataSell_8: string,
      txData?: Partial<TxData>
    ): Promise<boolean>;
  };
  approveOrder_: {
    sendTransactionAsync(
      ...
      replacementPattern_7: string,
      staticExtradata_8: string,
      orderbookInclusionDesired_9: boolean,
      txData?: Partial<TxData>
    ): Promise<string>;
    estimateGasAsync(
      addrs_0: string[],
