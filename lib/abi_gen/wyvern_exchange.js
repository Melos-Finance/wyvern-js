            ...
            callAsync: function (addrs_0, uints_1, feeMethod_2, side_3, saleKind_4, howToCall_5, calldata_6, replacementPattern_7, staticExtradata_8, txData) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                console.log("validateOrderParameters_: addrs_0=" + addrs_0 + ",uints_1=" + uints_1 + ",feeMethod_2=" + feeMethod_2 + ", side_3=" + side_3 + ",saleKind_4=" + saleKind_4 + ",howToCall_5=" + howToCall_5 + " ,\n        calldata_6=" + calldata_6 + ",replacementPattern_7=" + replacementPattern_7 + ", staticExtradata_8=" + staticExtradata_8 + ", txData=" + txData);
