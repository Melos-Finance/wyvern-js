    ...
    function WyvernAtomicizerContract(contract, defaults) {
        ...
        _this.atomicize = {
                        ...
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                return [2 /*return*/, new Promise(function (resolve, reject) {
                                        self.contract.methods.atomicize(addrs_0, values_1, calldataLengths_2, calldatas_3)
            ...
            estimateGasAsync: function (addrs_0, values_1, calldataLengths_2, calldatas_3, txData) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, this.contract.methods.atomicize(addrs_0, values_1, calldataLengths_2, calldatas_3).estimateGas(txData)];
                    });
                });
            },
