...
var WyvernAtomicizerContract = /** @class */ (function (_super) {
    ...
    function WyvernAtomicizerContract(contract, defaults) {
        ...
        _this.atomicize = {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                ...
                                return [4 /*yield*/, self.contract.methods.atomicize(addrs_0, values_1, calldataLengths_2, calldatas_3).send(txDataWithDefaults)];
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, this.contract.methods.atomicize(addrs_0, values_1, calldataLengths_2, calldatas_3).estimateGas(txDataWithDefaults)];
                            case 2: return [2 /*return*/, _a.sent()];
                        }
                    });
                });
            ...
            getABIEncodedTransactionData: function (addrs_0, values_1, calldataLengths_2, calldatas_3) {
                return this.contract.methods.atomicize(addrs_0, values_1, calldataLengths_2, calldatas_3).encodeABI();
            },
        };
