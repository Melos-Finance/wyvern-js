...
var WyvernProtocol = /** @class */ (function () {
    function WyvernProtocol(provider, config) {
        ...
        utils_1.providerUtils.standardizeOrThrow(provider);
        ...
        this.wyvernExchange = new wyvern_exchange_1.WyvernExchangeContract(new this._web3.eth.Contract(constants_1.constants.EXCHANGE_ABI, exchangeContractAddress), {});
        ...
        this.wyvernProxyRegistry = new wyvern_proxy_registry_1.WyvernProxyRegistryContract(new this._web3.eth.Contract(constants_1.constants.PROXY_REGISTRY_ABI, proxyRegistryContractAddress), {});
        ...
        this.wyvernAtomicizer = new wyvern_atomicizer_1.WyvernAtomicizerContract(new this._web3.eth.Contract(constants_1.constants.ATOMICIZER_ABI, atomicizerContractAddress), {});
    }
    ...
    WyvernProtocol.generatePseudoRandomSalt = function () {
        ...
        var randomNumber = bignumber_js_1.BigNumber.random(constants_1.constants.MAX_DIGITS_IN_UNSIGNED_256_INT);
        var factor = new bignumber_js_1.BigNumber(10).pow(constants_1.constants.MAX_DIGITS_IN_UNSIGNED_256_INT - 1);
        var salt = randomNumber.times(factor).integerValue(bignumber_js_1.BigNumber.ROUND_DOWN);
        return salt;
    };
    /**
    ...
    WyvernProtocol.toUnitAmount = function (amount, decimals) {
        ...
        var aUnit = new bignumber_js_1.BigNumber(10).pow(decimals);
    ...
    WyvernProtocol.toBaseUnitAmount = function (amount, decimals) {
        ...
        var unit = new bignumber_js_1.BigNumber(10).pow(decimals);
        var baseUnitAmount = unit
            .times(amount)
    ...
    WyvernProtocol.prototype.getAvailableAddressesAsync = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this._web3.eth.getAccounts()];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this._web3.eth.getNodeInfo()];
                    case 1:
                        nodeVersion = _a.sent();
                        ...
                        return [4 /*yield*/, this._web3.eth.sign(msgHashHex, signerAddress)];
                    case 2:
                        signature = _a.sent();
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    return [4 /*yield*/, this._web3.eth.getTransactionReceipt(txHash)];
                                case 1:
    ...
    WyvernProtocol.MAX_UINT_256 = new bignumber_js_1.BigNumber(2)
        .pow(256)
        .minus(1)
        .integerValue();
    /**
