...
exports.utils = {
    ...
    getOrderHashHex: function (order) {
        var orderParts = [
            ...
            { value: order.extra, type: types_1.SolidityTypes.Uint256 },
            {
            ...
            { value: order.salt, type: types_1.SolidityTypes.Uint256 },
        ];
    ...
    getCurrentUnixTimestampSec: function () {
        return new bignumber_js_1.BigNumber(Date.now() / 1000).integerValue();
    },
    getCurrentUnixTimestampMs: function () {
        return new bignumber_js_1.BigNumber(Date.now());
    },
};
