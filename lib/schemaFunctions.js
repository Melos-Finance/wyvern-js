...
var encodeAtomicizedSell = function (schema, assets, address, atomicizer) {
    ...
    var atomicizedCalldata = atomicizer.atomicize.getABIEncodedTransactionData(transactions.map(function (t) { return t.address; }), transactions.map(function (t) { return t.value; }), transactions.map(function (t) { return (0, web3_utils_1.toBN)((t.calldata.length - 2) / 2).toString(10); }), // subtract 2 for '0x', divide by 2 for hex
